...
function loadConfig() {
  return {
    ...
    pusher: {
      ...
      heartbeatEnabled: process.env.HEARTBEAT_ENABLED === "1", // 长任务心跳默认关闭
      heartbeatStartMs: 60 * 1000, // 首次提示阈值（60s）
      heartbeatIntervalMs: 120 * 1000, // 初始间隔（2min）
      heartbeatCapMs: 300 * 1000, // 间隔封顶（5min）
